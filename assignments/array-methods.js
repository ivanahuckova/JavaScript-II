...
ticketPriceTotal = runners.map(function(element) {
	return element.donation;
});

let ticketPriceTotalSum = ticketPriceTotal.reduce(function(
	accumulator,
	currentValue
) {
...
// ticketPriceTotalSum = ticketPriceTotal.reduce((accumulator, currentValue) => {
// 	return (accumulator += currentValue);
// }, 0);

console.log(ticketPriceTotal);
console.log(ticketPriceTotalSum);
...
console.log(donationMoreThan100);
